    ...
    return (
        <section className="container mx-auto">
            <div className="flex justify-between mb-20"> 
                ...
                >
                     <p className="flex mx-auto items-center gap-2">Hire <AiOutlineMail /></p> 
                </a>
            </div>
            <div className="bg-gray-300 rounded px-2 py-2 text-center mx-2 dark:bg-gray-700">
                 <h1 className="font-light sm:text-base md:text-lg lg:text-xl text-secondary dark:text-white">
                    ...
                    <span>
                      <Typewriter
                        words={['A developer based in Porto', 'Frontend enthusiast', 'Passionate for beautiful UI/UX designs', 'Love to learn','Love Teamwork']}
                        loop
                        cursor
                        cursorStyle='_'
                        typeSpeed={70}
