...
const Navbar = () => {
  ...
  return (
    <>
      <nav className='sticky top-0 z-50 bg-theme-light border-b-2 dark:border-primary border-teal dark:bg-secondary transition duration-500'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='flex items-center justify-between h-16'>
            <div className='flex items-center'>
              <div className='flex-shrink-0'>
                <img className='h-8 w-8' src={Logo} alt='Personal Logo' />
              </div>
            ...
            <div className='hidden md:flex items-center space-x-3 text-lg'>
              <a
                ...
                rel='noreferrer'
              >
                <BsGithub className='text-teal hover:opacity-80 dark:text-white dark:hover:text-black ' />
              </a>
              <a
                ...
                rel='noreferrer'
              >
                <BsLinkedin className='text-teal hover:opacity-80 dark:text-white dark:hover:text-primary' />
              </a>
              <Darkmode />
            </div>
        ...
        >
          {(ref) => (
            <div className='md:hidden' id='mobile-menu'>
              <ul
                ref={ref}
                className='sm:px-3 flex justify-center items-center flex-col gap-8'
              >
                <Link
                  to='/'
